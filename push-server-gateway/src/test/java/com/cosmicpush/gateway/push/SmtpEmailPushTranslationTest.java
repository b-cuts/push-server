...
public class SmtpEmailPushTranslationTest {
  ...
  public void translateEmailPush() throws Exception {
    Push oldPush = new SmtpEmailPush("mickey.mouse@disney.com", "donald.duck@disney.com", "This is the subject", "<html><body><h1>Hello World</h1>So, how's it going?</body></html>", "http://callback.com/api.sent", "test:true", "type:email");
