...
public class SesEmailPush extends EmailPush {
  ...
  public SesEmailPush(@JsonProperty("toAddress") String toAddress,
  ...
  public static SesEmailPush newPush(String toAddress, String fromAddress, String emailSubject, String htmlContent, String callbackUrl, InetAddress remoteAddress, String... traits) {
  ...
  public static SesEmailPush newPush(String toAddress, String fromAddress, String emailSubject, String htmlContent, String callbackUrl, InetAddress remoteAddress, Map<String, String> traits) {
